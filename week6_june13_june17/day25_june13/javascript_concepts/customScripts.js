...
window.onload = function() {
    ...
    document.getElementById('clearAllRecords').onclick = clearAllRecords;
    document.getElementById('removeRecord').onclick = removeRecord;
    document.getElementById('retreiveRecords').onclick = retreiveRecords;
}